...
export default function Todo() {
  return (
    <div className="gridContainer h-screen gap-4">
      {/* ASIDE  */}
      <div className="[grid-area: dashboard] dark:bg-gray-700 relative row-span-2 flex flex-col overflow-y-auto p-4 ">
        ASIDE
        <SideBar />
      </div>
      {/* FILTER - SEARCH */}
      <div className="[grid-area:filter] bg-gray-700 pt-3 pr-3 mr-3 mt-3 flex place-content-center">
        Filter
      </div>
      {/* MAIN TODO   */}
